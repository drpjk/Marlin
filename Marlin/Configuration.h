...
#define STRING_CONFIG_H_AUTHOR "(drpjk, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Prus I3 - drpjk"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "1d4557d8-109f-413e-8d41-5151cfdec479"
...
// 65 is 100k thermister calibrated against thermocouple with 4.65 k resistor
...
//============================ Mesh Bed Leveling ============================
//===========================================================================
#define AUTO_MESH_BED_LEVELING
#undef MANUAL_MESH_BED_LEVELING
#define MESH_BED_LEVELING    // Enable mesh bed leveling.

#if ENABLED(MESH_BED_LEVELING)
  #define MESH_MIN_X 20
  #define MESH_MAX_X 180
  #define MESH_MIN_Y 26
  #define MESH_MAX_Y 186
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -2.825   // Z offset: -below [the nozzle] (always negative!)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4031.496,595}  // default steps per unit for I3
#define DEFAULT_MAX_FEEDRATE          {200, 200, 3, 45}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,1000,4,3000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
